 ...
 *   !proto.aruku_interfaces.proto.Empty>}
 */
const methodDescriptor_Config_PublishConfig = new grpc.web.MethodDescriptor(
  '/aruku_interfaces.proto.Config/PublishConfig',
  grpc.web.MethodType.UNARY,
  proto.aruku_interfaces.proto.ConfigWalking,
  proto.aruku_interfaces.proto.Empty,
  /**
 ...
 *     The XHR Node Readable Stream
 */
proto.aruku_interfaces.proto.ConfigClient.prototype.publishConfig =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/aruku_interfaces.proto.Config/PublishConfig',
      request,
      metadata || {},
      methodDescriptor_Config_PublishConfig,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.aruku_interfaces.proto.ConfigPromiseClient.prototype.publishConfig =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/aruku_interfaces.proto.Config/PublishConfig',
      request,
